            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-6 text-right">
                  <a href="{{ route('admin.locations.create') }}" class="btn btn-sm btn-primary">New</a>
                  <button type="button" data-toggle="modal" data-target="#modal-filter" class="btn btn-sm btn-neutral">Filter</button>
                </div>
              </div>

              @include('rooms::admin.locations.partials.table')
...
@section('modal')
@parent
@include('rooms::admin.locations.partials.filter')
@stop
