...
class RoomsServiceProvider extends ServiceProvider
{
	...
	*/
	public function register()
	{
		...
		$this->app->bind(
		'Master\Rooms\Interfaces\TypesRepositoryInterface',
		\Master\Rooms\Repositories\Eloquent\TypesRepository::class
		);

		$this->app->bind(
		'Master\Rooms\Interfaces\LocationsRepositoryInterface',
		\Master\Rooms\Repositories\Eloquent\LocationsRepository::class
		);

		$this->app->bind(
		'Master\Rooms\Interfaces\OwnersRepositoryInterface',
		\Master\Rooms\Repositories\Eloquent\OwnersRepository::class
		);
