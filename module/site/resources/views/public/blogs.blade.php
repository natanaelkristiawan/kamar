    ...
    <div class="row">
        ...
        <div class="grid_blog_box">
          ...
          <div class="modern_property_footer">
            <div class="property-author">
              <div class="path-img"><a href="agent-page.html" tabindex="-1"><img src="https://via.placeholder.com/400x400" class="img-fluid" alt=""></a></div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="grid_blog_box">
          ...
          <div class="gtid_blog_thumb">
            <a href="blog-detail.html"><img src="https://via.placeholder.com/1200x800" class="img-fluid" alt="" /></a>
            <div class="gtid_blog_info">
              <span class="post-date"><i class="ti-calendar"></i>10 May 2020</span>
            </div>
          </div>                
      ...
      <div class="col-lg-4 col-md-6">
        <div class="grid_blog_box">
          ...
          <div class="blog-body">
            <h4 class="bl-title"><a href="blog-detail.html">Creative Designs</a></h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod. </p>
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="grid_blog_box">
          ...
          <div class="blog-body">
            <h4 class="bl-title"><a href="blog-detail.html">UX/UI Developer</a></h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod. </p>
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="grid_blog_box">
          ...
          <div class="blog-body">
            <h4 class="bl-title"><a href="blog-detail.html">WordPress Developer & UI</a></h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod. </p>
          </div>
