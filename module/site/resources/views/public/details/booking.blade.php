...
<div class="agent-_blocks_wrap">
  ...
  <div class="side-booking-body">
    ...
    <div class="row">
      <div id="main-data" class="collapse show"  style="width:100%; display: none">
      ...
      <div class="col-lg-12 col-md-12 col-sm-6 hide" id="checkout-button">
        ...
        <div class="form-group">
          <button type="button" disabled="" class="btn btn-theme full-width hide" id="bookingNow">{{ trans('site::default.book_it_now')  }}</button>
...
<script type="text/javascript">
  ...
  $('#bookingNowNew').on('click', function(){
    $('.modalLogin').click();
  })


  function newBookCalculate() {
    var params = {
      roomTotal : $('.rooms').val(),
    ...
    $('#btnCheckRoom').addClass('hide');
    $('#checkout-detail').removeClass('hide');
    $('#checkout-button').removeClass('hide');
    $('#bookingNow').removeClass('hide');
  }
  ...
  $(document).ready(function() {
    ...
    $('.rooms').on('select2:select', function (e) {
      if(!Boolean($('#bookingNow').hasClass('hide'))){
        newBookCalculate();
      }
    });
          ...
          if (response) {
            ...
            checkAvailability(params).then((response) => {
              ...
              if (response.status) {
                ...
                if (response.step == 'new_book_step') {
                  newBookCalculate();
                }
